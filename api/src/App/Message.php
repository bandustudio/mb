...
class Message extends \Spot\Entity
{
    ...
    public function transform(Message $message)
    {
        ...
        if(strlen(trim($message->user->first_name)) OR strlen(($message->user->last_name))){
            $title = implode(" ",array_values([$message->user->first_name,$message->user->last_name]));
        } else {
        ...
        return [
            ...
            "timespan" => \human_timespan_short($created->format('U')),
            "user" => [
